...
namespace GameEnginePipeline.Assets
{
	...
	public class AssetDictionary
	{
		...
		{
			BackingDictionary = new Dictionary<AssetID,IAsset>();
		...
		public bool TryGetAsset(AssetID id, [MaybeNullWhen(false)] out IAsset output) => BackingDictionary.TryGetValue(id,out output);
		...
		/// </summary>
		protected Dictionary<AssetID,IAsset> BackingDictionary
		{get;}
