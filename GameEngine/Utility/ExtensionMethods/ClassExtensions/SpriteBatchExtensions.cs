...
{
	/// <summary>
	/// Primitive drawing extensions for the SpriteRenderer class.
	/// </summary>
	public static class SpriteRendererExtensions
	{
		...
		public static void DrawLine(this SpriteRenderer renderer, Vector2 a, Vector2 b, Color tint, float thickness, float layer_depth)
		{
		...
		/// <param name="thickness">The thickness of the line.</param>
		/// <param name="layer_depth">The layer depth to draw at. This value should lie in the interval [0,1], where smaller values are considered the 'back' and larger values the 'front'.</param>
		public static void DrawLine(this SpriteRenderer renderer, Vector2 p, float length, float angle, Color tint, float thickness, float layer_depth)
		{
		...
		/// <param name="thickness">The thickness of the line.</param>
		/// <param name="layer_depth">The layer depth to draw at. This value should lie in the interval [0,1], where smaller values are considered the 'back' and larger values the 'front'.</param>
		public static void DrawLine(this SpriteRenderer renderer, Texture2D line_texture, Vector2 a, Vector2 b, Color tint, float thickness, float layer_depth)
		{
			// Remember that the y-axis points down in screen coordinates, so to get the right (oppositely signed) angle, we swap b.Y - a.Y to a.Y - b.Y
		...
		/// <param name="thickness">The thickness of the line.</param>
		/// <param name="layer_depth">The layer depth to draw at. This value should lie in the interval [0,1], where smaller values are considered the 'back' and larger values the 'front'.</param>
		public static void DrawLine(this SpriteRenderer renderer, Texture2D line_texture, Vector2 p, float length, float angle, Color tint, float thickness, float layer_depth)
		{
		...
		public static void DrawPolygon(this SpriteRenderer renderer, Color tint, float thickness, float layer_depth, params Vector2[] points)
		{
		...
		/// <param name="layer_depth">The layer depth to draw at. This value should lie in the interval [0,1], where smaller values are considered the 'back' and larger values the 'front'.</param>
		/// <param name="points">The points of the polygon in clockwise or counterclockwise order. An extra line from the last to the first will be drawn to complete the polygon.</param>
		public static void DrawPolygon(this SpriteRenderer renderer, Color tint, float thickness, float layer_depth, IReadOnlyList<Vector2> points)
		{
		...
		/// <param name="layer_depth">The layer depth to draw at. This value should lie in the interval [0,1], where smaller values are considered the 'back' and larger values the 'front'.</param>
		/// <param name="points">The points of the polygon in clockwise or counterclockwise order. An extra line from the last to the first will be drawn to complete the polygon.</param>
		public static void DrawPolygon(this SpriteRenderer renderer, Texture2D line_texture, Color tint, float thickness, float layer_depth, params Vector2[] points)
		{
		...
		/// <param name="layer_depth">The layer depth to draw at. This value should lie in the interval [0,1], where smaller values are considered the 'back' and larger values the 'front'.</param>
		/// <param name="points">The points of the polygon in clockwise or counterclockwise order. An extra line from the last to the first will be drawn to complete the polygon.</param>
		public static void DrawPolygon(this SpriteRenderer renderer, Texture2D line_texture, Color tint, float thickness, float layer_depth, IReadOnlyList<Vector2> points)
		{
		...
		public static void DrawRegularNGon(this SpriteRenderer renderer, Vector2 center, float radius, float angle, Color tint, float thickness, float layer_depth, int n)
		{
		...
		/// <param name="layer_depth">The layer depth to draw at. This value should lie in the interval [0,1], where smaller values are considered the 'back' and larger values the 'front'.</param>
		/// <param name="n">The number of sides to the n-gon.</param>
		public static void DrawRegularNGon(this SpriteRenderer renderer, Texture2D line_texture, Vector2 center, float radius, float angle, Color tint, float thickness, float layer_depth, int n)
		{
		...
		public static void DrawCircle(this SpriteRenderer renderer, Vector2 center, float radius, Color tint, float thickness, float layer_depth, int approximation_points = 20)
		{
		...
		/// <param name="layer_depth">The layer depth to draw at. This value should lie in the interval [0,1], where smaller values are considered the 'back' and larger values the 'front'.</param>
		/// <param name="approximation_points">The number of points to draw the circle with. In practice, we draw a regular <paramref name="approximation_points"/>-gon to approximate the circle.</param>
		public static void DrawCircle(this SpriteRenderer renderer, Texture2D line_texture, Vector2 center, float radius, Color tint, float thickness, float layer_depth, int approximation_points = 20)
		{
			// I don't know why you would want this, but just no
		...
		/// </summary>
		private static Texture2D GetPixel(this SpriteRenderer renderer)
		{
			if(_dp is null)
			{
